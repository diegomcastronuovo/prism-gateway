...
export async function GET(request: Request) {
  ...
  const url = `${baseUrl}/admin/billing/report.csv?window_hours=${encodeURIComponent(windowHours)}`
  ...
  try {
    ...
    return new NextResponse(body, {
      headers: {
        ...
        'Content-Disposition': contentDisposition ?? 'attachment; filename="billing_report.csv"',
